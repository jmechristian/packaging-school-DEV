        ...
        >
          <div className='col-span-1 md:col-span-2 my-4 w-full '>
            <label className='text-base font-semibold text-gray-900 w-full'>
              Rate your experience working with The Packaging School (1 low, 10
              high)<sup>*</sup>
            </label>
          ...
          <div className='col-span-1 md:col-span-2 my-4 w-full '>
            <label className='text-base font-semibold text-gray-900 w-full'>
              If applicable, how satisfied are you with the learning management
              platform?<sup>*</sup>
            </label>
            <fieldset className='mt-4'>
              <legend className='sr-only'>
          ...
          <div className='col-span-1 md:col-span-2 my-4 w-full '>
            <label className='text-base font-semibold text-gray-900 w-full'>
              How satisfied are you with the content of the lessons?<sup>*</sup>
            </label>
            <fieldset className='mt-4'>
              <legend className='sr-only'>
                Rate your experience working with The Packaging School (1 low,
          ...
          <div className='col-span-1 md:col-span-2 my-4 w-full '>
            <label className='text-base font-semibold text-gray-900 w-full'>
              How likely is it that you would recommend The Packaging School to
              a friend or colleague?<sup>*</sup>
            </label>
            <fieldset className='mt-4'>
              <legend className='sr-only'>
                Rate your experience working with The Packaging School (1 low,
