  ...
  return (
    <div className='flex flex-col pt-4 pb-24 gap-6'>
      ...
      <div className='flex flex-col gap-10'>
        <CMPMFormNav />
        <FormWrapper>
          <div className='border-b border-slate-300 border-t py-10 flex flex-col gap-3'>
          ...
          <div className='mt-6 flex w-full items-center justify-end gap-x-9 col-span-2'>
            <button
              type='button'
              className='text-lg font-semibold font-greycliff leading-6 text-gray-900'
            >
              Save
            </button>
            <button
              type='submit'
              className='rounded-md bg-base-brand px-4 py-3 text-lg font-semibold text-white shadow-sm font-greycliff hover:bg-clemson-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-600'
            >
              Save and Continue
            </button>
          </div>
