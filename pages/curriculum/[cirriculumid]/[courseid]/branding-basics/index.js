...
const Page = () => {
  ...
  return (
    <div className='bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] bg-no-repeat from-white dark:from-dark-dark dark:via-dark-mid dark:to-neutral-900 via-base-light  to-white flex flex-col pt-24'>
