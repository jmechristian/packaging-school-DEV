      ...
      <div>
        <div className='max-w-prose dark:text-white mx-auto px-6 lg:px-0 md:text-lg flex flex-col gap-12'>
          <p>
            ...
            Resources, Sales Performance, Diversity, Equity & Inclusion, and the
            Future of Work.
          </p>
          <p>
            The Packaging School, a leader in innovative online education for
            the packaging industry worldwide, along with our multi-year client,
            Colgate, won a coveted Brandon Hall Group Silver and Bronze award
            for excellence in the category of Best Advance in Custom Content and
            Best Advance in Competencies and Skill Development for the entry:
            Packaging Curricula—Processes & Materials.
          </p>
          <p>
          ...
          <p>
            ...
            capital management programs. These HCM programs have been validated
            as best in class for business value and the impact on the employees
            themselves,&quot; said Brandon Hall Group Chief Operating Officer
            Rachel Cooke, HCM Excellence Awards program leader.
          </p>
          <p>
          ...
          <p>
            Excellence Award winners will continue to be honored at Brandon Hall
            Group&apos;s HCM Excellence Conference, February 13-15, 2024, at the
            Hilton West Palm Beach, Florida. Select winners also will serve as
            presenters in breakout sessions, sharing their leading practices
            during the conference.
          </p>
          <p>
            &quot;Our award winners are relentless in their pursuit of
            excellence,&quot; said Brandon Hall Group Chief Executive Officer
            Mike Cooke.&quot;We have received some of the most innovative use of
            HCM strategy that we have seen in the last 30 years, and in most
            cases, technology and collaboration across departments have helped
            them achieve amazing business results.
          </p>
          <div className='flex flex-col gap-3'>
            <h2 className='text-xl text-clemson'>About the Packaging School</h2>
            <p>
              The Packaging School is committed to developing new and empowering
              current packaging, logistics, and supply chain professionals
              globally in the art and science of packaging. Our distance
              education offerings are focused on dissemination of the highest
              quality, accessible, valuable, and professionally applicable
              information. The Packaging School bridges the gap between academia
              and industry by partnering with companies, subject matter experts
              and associations to create a shared learning management system.
              Our expanded catalog will enable knowledge-seekers to connect with
              knowledge-providers in all facets of packaging and processing. The
              Packaging School is the official licensee of Clemson University’s
              packaging curriculum, developed over a decade by leading faculty.
          ...
          <p>
            ...
            Awards program was the first to recognize organizations for learning
            and talent and is the gold standard, known as the &quot;Academy
            Awards of Human Capital Management.&quot;
          </p>
          <p>
            The awards recognize the best organizations that have successfully
            developed and deployed programs, strategies, modalities, processes,
            systems, and tools that have achieved measurable results. We are
            honored to receive applications from organizations worldwide ranging
            from small, medium, large, and global enterprises to government,
