          ...
          <div className='lg:col-span-4 py-10 lg:border-r-black lg:border-r-2'>
            <div className='flex flex-col w-full max-w-[300px] border-2 border-black mx-auto'>
              <div className='bg-amber-300 text-black font-medium text-xl flex items-center gap-3 p-3 cursor-pointer'>
                ...
                <div className=' leading-none'>Food Packaging Certificate</div>
              </div>
              <div
            ...
            <div className='w-full flex flex-col justify-between gap-6 h-full'>
              ...
              <div className='flex flex-col md:flex-row items-end justify-between'>
                <p className='text-lg max-w-lg pr-8'>
                  Elevate Your Presence, Enlighten The Industry. By choosing to
                  sponsor, you play a pivotal role in enriching the knowledge
                  base of countless food packaging experts, showcasing the
                  unparalleled value your brand brings to the forefront.
                  Position your business at the heart of innovation, where your
                  executives emerge as the leading voices of authority. Take
                  this opportunity to not just be seen, but to significantly
                  impact and shape the future of the food packaging sector.
                </p>
