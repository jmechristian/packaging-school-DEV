            ...
            <div className='flex flex-col gap-10 lg:gap-16 lg:col-span-3'>
              ...
              <div className='flex flex-col gap-3'>
                ...
                <div className='text-lg'>
                  ...
                  assignments, knowledge checks, discussion, and surveys. While
                  everything is online and housed within a learning management
                  system, virtual meetings with Cory are part of this program.
                </div>
              </div>
              <div className='flex flex-col gap-5'>
                <div className='h3-base'>Why Learn in a Cohort:</div>
                <div className='flex flex-col gap-5 pl-3 text-lg'>
                  <div>
                    <span className='font-bold block text-base-brand'>
                      Social Support and Networking:
                    </span>
                    Cohorts foster a sense of community among students. They
                    provide opportunities for networking, collaboration, and
                    peer support. Students can share experiences, ideas, and
                    resources, enhancing their learning through discussions and
                    group projects.
                  </div>
                  <div>
                    <span className='font-bold block text-base-brand'>
                  ...
                  <div>
                    ...
                    instructors and peers, which can accelerate learning and
                    skill development.
                  </div>
                  <div>
                    <span className='font-bold block text-base-brand'>
                    ...
                    include individuals from diverse backgrounds and
                    experiences. This diversity enriches discussions and exposes
                    students to different viewpoints, preparing them for
                    collaborative work in future careers.
                  </div>
                  <div>
                    <span className='font-bold block text-base-brand'>
                  ...
                  <div>
                    ...
                    Cohorts often continue to stay connected even after
                    completing the program. This can lead to long-term
                    professional relationships, mentorship opportunities, and
                    access to alumni networks that support career advancement.
                  </div>
                </div>
              </div>
