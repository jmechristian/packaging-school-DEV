...
const StudentSuccess = () => {
  return (
    <section className='container__inner'>
      <div className='border bg-white border-black drop-shadow-lg p-8 lg:p-12'>
        <div className='grid grid-cols-1 gap-3'>
          ...
          <div className='text-neutral-600 font-light text-xl lg:text-2xl -mt-16'>
            The CMPM program exceeded my expectations regarding packaging
            machine systems, sustainability, and point of purchase strategies,
            through a complete and holistic approach to the different aspects of
            packaging.
          </div>
