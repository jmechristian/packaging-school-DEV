    ...
    <div className='w-full max-w-2xl bg-white border-2 border-black flex flex-col shadow-2xl'>
      <div className='w-full bg-black py-3 px-3 flex items-center justify-between'>
        <div className='w-full flex gap-1 items-center'>
          <div className=' text-white h3-base'>Monthly Library Updates</div>
        </div>
        <div className='text-sm text-gray-400'>5/6</div>
      </div>
      <div className='bg-white p-5 lg:p-10 text-lg leading-snug'>
        We add a freshly produced video lesson to your library each month based
        on current industry trends. It’s free.
      </div>
