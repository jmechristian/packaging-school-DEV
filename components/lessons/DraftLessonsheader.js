...
const DraftLessonsHeader = ({ id, title, subhead, tags, author, date }) => {
      ...
      <div>
        ...
        {date && (
          <div className='flex gap-2 text-sm mt-2'>
            ...
            {author.length > 0 &&
              author.map((a) => (
                <div className='text-clemson' key={a.draftAuthor.name}>
                  <a
                    href={a.draftAuthor.linkedIn}
                    rel='noreferrer'
                    target='_blank'
                  >
                    {'/' +
...
export default DraftLessonsHeader;
