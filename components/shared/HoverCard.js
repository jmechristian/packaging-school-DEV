...
const HoverCard = ({ title, subtitle, Icon, href }) => {
  ...
  return (
    <div
      href={href}
      className='w-full p-6 rounded border-[1px] border-neutral-300 dark:border-base-dark relative overflow-hidden group bg-white dark:bg-base-brand cursor-pointer'
    ...
    >
      ...
      <h2 className='font-bold mt-4 lg:mt-0 leading-snug text-xl md:text-xl text-neutral-950 group-hover:text-brand-yellow relative z-10 duration-200'>
        {title}
      </h2>
