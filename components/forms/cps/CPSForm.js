...
const CPSForm = ({ methods }) => {
  ...
  return (
    ...
    >
      <div id='personal' className='flex flex-col gap-6 py-6 scroll-mt-24'>
        <div className='text-xl lg:text-2xl lg:mb-4 font-greycliff font-semibold'>
          Personal Information
        </div>
        <CPSPersonalInfo />
      </div>
      <div id='professional' className='py-6 scroll-mt-24 flex flex-col gap-6'>
        <div className='text-xl lg:text-2xl lg:mb-4 font-greycliff font-semibold'>
          Professional Information
        </div>
        <CPSProfessionalInfo />
      </div>
      <div id='goals' className='py-6 scroll-mt-24 flex flex-col gap-6'>
        <div className='text-xl lg:text-2xl lg:mb-4 font-greycliff font-semibold'>
          Professional Goals
        </div>
        <CPSGoals />
      </div>
      <div id='session' className='py-6 scroll-mt-24 flex flex-col gap-6'>
        <div className='text-xl lg:text-2xl lg:mb-4 font-greycliff font-semibold'>
          Session Info
        </div>
        <CPSApply />
